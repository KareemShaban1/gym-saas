      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <h1 className="text-2xl font-display font-bold">{t("gymLogin")}</h1>
            <p className="text-muted-foreground mt-1 text-sm">
              {fromDashboard ? "Sign in to access your dashboard" : "Sign in to manage your gym — or register below."}
            </p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-4 rounded-xl border bg-card p-6 shadow-sm">
            ...
            <Button type="button" variant="outline" className="w-full h-11" asChild>
              <Link to="/register-gym">{t("registerGym")}</Link>
            </Button>
          </form>
          <p className="text-center text-sm text-muted-foreground">
            {t("memberPortal")} · <Link to="/member/login" className="text-primary font-medium hover:underline">Sign in</Link>
            {" · "}
            {t("trainerPortal")} · <Link to="/trainer/login" className="text-primary font-medium hover:underline">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
